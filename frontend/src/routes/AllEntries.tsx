      ...
      {entries.map((entry: Entry, index: number) => {
        return (
          <div
            id={entry.id}
            key={index}
            className="bg-gray-300 dark:bg-gray-600 shadow-md shadow-gray-500 m-3 p-4 rounded justify-between flex flex-col"
          >
            ...
            <section className="flex items-center justify-between flex-col pt-2">
              <time className="flex text-left text-sm ">
                {" "}
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="m-1 p-1 font-semibold rounded-md bg-red-500 hover:bg-red-700"
                >
                  Delete
                </button>
                <button
                  ...
                  className="m-1 p-1 font-semibold rounded-md bg-blue-500 hover:bg-blue-700"
                >
                  Edit
                </button>
              </div>

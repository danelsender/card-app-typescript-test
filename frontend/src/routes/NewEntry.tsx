...
export default function NewEntry(){
    ...
    return(
        <section className="entryBox">
            ...
            <button onClick={(e) => {handleSend(e)}} className="bg-blue-400 dark:bg-green-800 hover:bg-blue-600 dark:hover:bg-green-600 font-semibold text-white p-3 rounded-md">Create</button>
        </section>
    )
}